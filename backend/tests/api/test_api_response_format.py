"""
Tests for API response format using a simplified test app
"""
import pytest
import sys
import os

# Add parent directory to path so pytest can find the simple_conftest
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '..')))

# Use the simple conftest instead of the main one
pytest_plugins = ["simple_conftest"]
...
def test_not_found_exception_response(client):
    """
